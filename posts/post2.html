...
<head>
  <meta charset="UTF-8">
  <title>Defining Core Functional Requirements</title>
</head>
<body>

  <h1>Defining Core Functional Requirements: What is Essential and What is Optional?</h1>

  <p><strong>Date:</strong> 2026-04-17</p>
  <p><strong>Author:</strong> Yan LIU</p>
  <p><strong>Summary:</strong> Identifying essential features and managing scope through prioritization and trade-offs.</p>

  <p><strong>Tags:</strong> functional-requirements, scope, design-decisions</p>
